...
class UNet3D(nn.Module):
    def __init__(self,img_ch=4,output_ch=3):
        ...
        self.Up_conv6 = conv_block(ch_in=nf*24, ch_out1=nf*12, ch_out2=nf*12, k1=3, k2=3, s1=1, s2=1)

        self.Up5 = up_conv(ch_in=nf*12, ch_out=nf*8)
        self.Up_conv5 = conv_block(ch_in=nf*16, ch_out1=nf*8, ch_out2=nf*8, k1=3, k2=3, s1=1, s2=1)

        self.Up4 = up_conv(ch_in=nf*8, ch_out=nf*6)
        self.Up_conv4 = conv_block(ch_in=nf*12, ch_out1=nf*6, ch_out2=nf*6, k1=3, k2=3, s1=1, s2=1)

        self.Up3 = up_conv(ch_in=nf*6, ch_out=nf*4)
        self.Up_conv3 = conv_block(ch_in=nf*8, ch_out1=nf*4, ch_out2=nf*4, k1=3, k2=3, s1=1, s2=1)
        self.Conv_1x13 = nn.Conv3d(nf*4,output_ch, kernel_size=1, stride=1, padding=0)

        self.Up2 = up_conv(ch_in=output_ch, ch_out=nf*3)
        self.Up_conv2 = conv_block(ch_in=nf*6, ch_out1=nf*3, ch_out2=nf*3, k1=3, k2=3, s1=1, s2=1)
        self.Conv_1x12 = nn.Conv3d(nf*3,output_ch, kernel_size=1, stride=1, padding=0)

        self.Up1 = up_conv(ch_in=output_ch, ch_out=nf*2)
        self.Up_conv1 = conv_block(ch_in=nf*4, ch_out1=nf*2,ch_out2=nf*2, k1=3, k2=3, s1=1, s2=1)
        self.Conv_1x11 = nn.Conv3d(nf*2,output_ch, kernel_size=1, stride=1, padding=0)
